...
interface CardBackFormPropsITF {
...
const CardBackForm = ({ bookDetails, author, readerBookId, indicatorTransitionTimer, handleFlip, handleUpdateBookDetails, handleUpdateAuthorDetails, handleUpdateReaderBook }: CardBackFormPropsITF) => {
  ...
  const inputFunctionsList: {[key: string]: { setInput: Function, setIsSubmitSuccess: Function, setIsSubmitFail: Function, setFeedbackText: Function }} = {
    title: { setInput: setTitle, setIsSubmitSuccess: setIsSubmitTitleSuccess, setIsSubmitFail: setIsSubmitTitleFail, setFeedbackText: setTitleFeedbackText },
    author: { setInput: setNewAuthor, setIsSubmitSuccess: setIsSubmitAuthorSuccess, setIsSubmitFail: setIsSubmitAuthorFail, setFeedbackText: setAuthorFeedbackText },
    format: { setInput: setFormat, setIsSubmitSuccess: setIsSubmitFormatSuccess, setIsSubmitFail: setIsSubmitFormatFail, setFeedbackText: setFormatFeedbackText },
    totalPages: { setInput: setTotalPages, setIsSubmitSuccess: setIsSubmitTotalPagesSuccess, setIsSubmitFail: setIsSubmitTotalPagesFail, setFeedbackText: setTotalPagesFeedbackText },
    publishedDate: { setInput: setPublishedDate, setIsSubmitSuccess: setIsSubmitPublishedDateSuccess, setIsSubmitFail: setIsSubmitPublishedDateFail, setFeedbackText: setPublishedDateFeedbackText },
    editionDate: { setInput: setEditionDate, setIsSubmitSuccess: setIsSubmitEditionDateSuccess, setIsSubmitFail: setIsSubmitEditionDateFail, setFeedbackText: setEditionDateFeedbackText },
    bookCoverUrl: { setInput: setBookCoverUrl, setIsSubmitSuccess: setIsSubmitBookCoverUrlSuccess, setIsSubmitFail: setIsSubmitBookCoverUrlFail, setFeedbackText: setBookCoverUrlFeedbackText },
    blurb: { setInput: setBlurb, setIsSubmitSuccess: setIsSubmitBlurbSuccess, setIsSubmitFail: setIsSubmitBlurbFail, setFeedbackText: setBlurbFeedbackText }
  };
  ...
  const resetInputSubmitStates = (input: string) => {
    inputFunctionsList[input].setIsSubmitSuccess(false);
    inputFunctionsList[input].setIsSubmitFail(false);
    //delay reset of feedbackText to show fade out transition.
    let delayReset: ReturnType<typeof setTimeout>;
    delayReset = setTimeout(() => {
      inputFunctionsList[input].setFeedbackText('');
  ...
  const toggleInputSubmitSuccessState = (input: string) => {
    inputFunctionsList[input].setIsSubmitSuccess(true);
    inputFunctionsList[input].setIsSubmitFail(false);
  };

  const toggleInputSubmitFailState = (input: string) => {
    inputFunctionsList[input].setIsSubmitSuccess(false);
    inputFunctionsList[input].setIsSubmitFail(true);
  };

  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    inputFunctionsList[e.target.name].setInput(e.target.value);
  };
  //---
