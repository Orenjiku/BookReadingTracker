      ...
      <form className='h-full w-full flex flex-col justify-center items-center border-t border-b border-trueGray-50'>
        <div className='flex justify-center mx-1'>
          <div className='mr-0.5' style={{flexBasis: '66.66%'}}>
            <FormLabel type='input' label='Date' name='currentDate' value={currentDate} placeholder='yyyy-mm-dd' submitStatus={[false]} handleInputChange={handleInputChange} />
          </div>
          <div className='ml-0.5' style={{flexBasis: '33.33%'}}>
            <FormLabel type='input' label='Page' name='currentPage' value={currentPage} placeholder='#' submitStatus={[false]} handleInputChange={handleInputChange} />
          </div>
        </div>
